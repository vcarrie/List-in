...
@section('main')
    ...
    <div class="row ml" >
        <div class="col-md-8 col-md-offset-2">
            ...
            <p>
                Le site est par principe accessible aux utilisateurs 24/24h et 7/7j, sauf interruption, programmée ou
                non, pour des besoins de maintenance ou en cas de force majeure.
            </p>
            <p>
            ...
            <p>
                Ce site est déclaré à la Convention Nationale Informatique et Libertés (CNIL) sous les numéros suivants
                : 2118467.
            </p>
            <p>
                En outre, il est conform aux dispositions de la Loi 78-17 du 6 Janvier relative àl'informatique, aux
                fichiers et aux libertés. En vertu de celle-ci l'Utilisateur bénéficie notamment d'un droit d'opposition
                (art. 32 et 38), d'accès, (art. 38 et 39) et de réctification (art. 40) des données le concernant.
            </p>
            <p>
            ...
            <p>
                Le site List'In a eventuellement recours aux techniques de "cookies" lui permettant de traiter des
                statistiques et des informations sur le trafic, de faciliter la navigation et d'améliorer le service
