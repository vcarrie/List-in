    ...
    <div class="row cgu">
        <div class="col-md-8 col-md-offset-2">
            ...
            <p>
                ...
                modalités de mise à disposition des services du site listin.fr et leur utilisation par l’« Utilisateur
                ».
            ...
            <p>
                L'édition du site listin.fr est assurée par l’équipe “List’in” composée de 5 étudiants en Licence
                Professionnelle DAWIN (Développement d’Applications Web et Innovation Numériques) au capital de 0 € dont
                le siège social est situé en “salle screen” à l’IUT Informatique de Bordeaux, 15 Rue de Naudet, 33 175
                Gradignan.
            </p>
            <p>
            ...
            <ul>
                <li>Utilisateur : ce terme désigne toute personne qui utilise le site ou l'un des services proposés par
                    le site.
                </li>
                ...
                <li>Identifiant et mot de passe : c'est l'ensemble des informations nécessaires à l'identification d'un
            ...
            <ul>
                <li>une recherche de listes de produits par tags.</li>
                <li>création de listes de produits.</li>
                <li>ajout de listes dans un panier, achat redirigé vers le site de CDiscount.</li>
                <li>publication de commentaires et/ou noter une liste.</li>
            </ul>
            <p>
            ...
            <p>
                ...
                serveur n'engage pas la responsabilité de List’In.
            </p>
            <p>
                L'accès aux services du site peut à tout moment faire l'objet d'une interruption, d'une suspension,
                d'une modification sans préavis pour une maintenance ou pour tout autre cas. L'Utilisateur s'oblige à ne
                réclamer aucune indemnisation suite à l'interruption, à la suspension ou à la modification du présent
                contrat.
            </p>
            <p>
            ...
            <p>
                ...
                utilisation des contenus à des fins commerciales est strictement interdite.
            </p>
            <p>
                Tout contenu mis en ligne par l'Utilisateur est de sa seule responsabilité.
            </p>
            <p>
                L'Utilisateur s'engage à ne pas mettre en ligne de contenus pouvant porter atteinte aux intérêts de
            ...
            <p>
                ...
                et aux libertés. Le site est déclaré à la CNIL sous le numéro 2118467.
            </p>
            <p>
            ...
            <p>
                Les sources des informations diffusées sur le site sont réputées fiables. Toutefois, le site se réserve
                la faculté d'une non-garantie de la fiabilité des sources. Les informations données sur le site le sont
                à titre purement informatif. Ainsi, l'Utilisateur assume seul l'entière responsabilité de l'utilisation
            ...
            <p>
                ...
                par le site. Toutefois, le site s'engage à mettre en œuvre tous les moyens nécessaires afin de garantir
                au mieux la sécurité et la confidentialité des données.
            </p>
            <p>
            ...
            <p>
                Des liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens
                n'engagent en rien la responsabilité de List’in qui n'a pas le contrôle de ces liens.
            </p>
            <p>
            ...
            <p>
                Le site permet aux membres de publier des commentaires ainsi que de publier des listes.
            </p>
            <p>
            ...
            <p>
                Le site exerce une modération a priori (proposition de nouveaux tags) et a posteriori (contenu de listes
                indésirable) sur les publications et se réserve le droit de refuser leur mise en ligne, sans avoir à
            ...
            <p>
                ...
                une publication sur le site, il cède à la société éditrice le droit non exclusif et gratuit de
                ...
                propriété intellectuelle. Le Membre cède notamment le droit d'utiliser sa publication sur internet et
